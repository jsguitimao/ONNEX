...
export const onboardingSchema = z.object({
  ...
  headline: z.preprocess(normalizeString, z.string().max(140)),
  subheadline: z.preprocess(normalizeString, z.string().max(300)),
  welcomeMessage: z.preprocess(normalizeString, z.string().max(240)),
