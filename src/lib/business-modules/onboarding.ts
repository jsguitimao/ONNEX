...
export async function getBusinessForOnboarding() {
  ...
  return {
    ...
    aboutImageUrl: business.bookingPage?.aboutImageUrl ?? "",
    servicesImageUrl: business.bookingPage?.servicesImageUrl ?? "",
    teamImageUrl: business.bookingPage?.teamImageUrl ?? "",
      ...
      bookingPage: {
        upsert: {
          create: {
            ...
            aboutImageUrl: input.aboutImageUrl || null,
            servicesImageUrl: input.servicesImageUrl || null,
            teamImageUrl: input.teamImageUrl || null,
